#!/usr/bin/env bash
# Build the FX Opportunity Advisor example.
#
...
#
# UI half: the Vue + Vite WebView bundle -> ui/dist -> ui.zip (Vite builds
# src/main.ts with base "./" and no module preload / inline scripts, so the
